...
9. Finish only under the shared completion contract, including the integrated checks. Honor user stopping; report unresolved work without claiming success.
